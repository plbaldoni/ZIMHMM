...
The goal of ZIMHMM (Zero Inflated Mixed effects Hidden Mark Model) is to provide a peak caller
tailored to detect broad enrichment regions from multiple ChIP-seq experimental replicates. This (under development) package implements `ZIMHMM()` as well as the fixed effects version `ZIHMM()`.
